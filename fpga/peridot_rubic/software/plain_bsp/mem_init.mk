...
# Memory: ram_http
MEM_1 := plain_ram_http
$(MEM_1)_NAME := ram_http
...
$(MEM_1)_START := 0x0fffc000
$(MEM_1)_END := 0x0fffc7ff
$(MEM_1)_SPAN := 0x00000800
$(MEM_1)_HIERARCHICAL_PATH := ram_http
$(MEM_1)_WIDTH := 32
...
.PHONY: ram_http
ram_http: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
